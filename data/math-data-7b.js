            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "同位角和同旁内角的度数",
                    "explain": "题目已知一个角是65°，要求出它的同位角和同旁内角各是多少度"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "已知一个角是65°，两直线平行",
                    "explain": "两条平行线被一条直线所截，量得其中一个角是65°"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "同位角相等：65°；同旁内角互补：180°−65°=115°",
                        "同位角与同旁内角都等于65°",
                        "两角相加65°",
                        "同旁内角等于同位角的一半"
                    ],
                    "answer": "同位角相等：65°；同旁内角互补：180°−65°=115°",
                    "explain": "两条平行线被截：同位角相等，所以同位角=65°；同旁内角互补，所以同旁内角=180°−65°=115°"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "两条平行线被第三条直线所截：同位角在截线同侧同一方位，同旁内角在截线两侧、两条线之间",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "A、B两点之间的距离",
                    "explain": "题目给了A(3,4)、B(6,8)，要求两点间的距离"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "A(3,4)、B(6,8)：横差6−3=3，纵差8−4=4",
                        "两点都在数轴上",
                        "A和B是同一个点",
                        "只知道A点坐标"
                    ],
                    "answer": "A(3,4)、B(6,8)：横差6−3=3，纵差8−4=4",
                    "explain": "横坐标差3、纵坐标差4，两条线段互相垂直"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
            ...
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "坐标系中A(3,4)连到B(6,8)，横差3、纵差4构成直角三角形",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "内角45°、60°，内角和是180°",
                    "explain": "任何三角形三个内角合起来是180°"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "180°−45°−60°=75°",
                    "explain": "第三个角=内角和−已知两角=180°−45°−60°=75°"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "用180°减去已知的两个角：180°−45°−60°=75°",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "周长24米，长=宽的2倍−1米",
                    "explain": "栅栏24米就是长方形的周长，长比宽的2倍少1米"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "设宽=x：2(x+2x−1)=24，解得x=4",
                        "直接24÷2=12",
                        "24−1=23",
                        "24÷4=6"
                    ],
                    "answer": "设宽=x：2(x+2x−1)=24，解得x=4",
                    "explain": "周长=2(长+宽)=2(x+2x−1)=24，6x−2=24，x=4（宽），长=2×4−1=7"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "列方程2(x+2x−1)=24，6x=26，x=4（宽），长=2×4−1=7",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "内角和1080°，公式(n−2)×180°",
                    "explain": "n边形内角和=(n−2)×180°，本题内角和是1080°"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "(n−2)×180°=1080°，n−2=6，n=8",
                    "explain": "1080°÷180°=6，n−2=6，n=8，所以是八边形"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "n边形内角和公式：S=(n−2)×180°，已知内角和可推边数",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ]
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "原三角形面积和底增加后增加的面积",
                    "explain": "求原三角形面积，以及底增加4米后多出的面积"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "底12米、高8米、底要增加4米",
                    "explain": "原三角形底12米、高8米，底边再延长4米"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "原面积=12×8÷2=48；增加面积=4×8÷2=16",
                        "12×8=96",
                        "(12+4)×8=128",
                        "8×4÷12"
                    ],
                    "answer": "原面积=12×8÷2=48；增加面积=4×8÷2=16",
                    "explain": "三角形面积=底×高÷2：原面积48平方米；高不变，增加部分也是三角形，面积=4×8÷2=16"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "原面积=12×8÷2=48；增加面积=4×8÷2=16",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "三角形面积=底×高÷2，只变底时面积按底的增量×高÷2增加",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ]
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "面积=底×高=15×8=120",
                    "explain": "平行四边形面积=底×对应高=15×8=120平方米"
                }
            ],
            "explainLayers": [
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "梯形的面积",
                    "explain": "已知上底6厘米、下底10厘米、高5厘米，求面积"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "上底6厘米、下底10厘米、高5厘米",
                    "explain": "上底=6、下底=10、高=5"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "(6+10)×5÷2=40",
                    "explain": "梯形面积=(上底+下底)×高÷2=(6+10)×5÷2=40平方厘米"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "面积=(上底+下底)×高÷2=(6+10)×5÷2=40平方厘米",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "周长36米，长=宽的2倍",
                    "explain": "篱笆36米是周长，长是宽的2倍"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "设宽=x：2(x+2x)=36，解得x=6",
                        "36÷2=18",
                        "36÷4=9",
                        "x+2x=36"
                    ],
                    "answer": "设宽=x：2(x+2x)=36，解得x=6",
                    "explain": "周长=2(长+宽)=2(x+2x)=36，3x=18，x=6（宽），长=2×6=12"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "周长=2(长+宽)，已知周长与长宽的倍数关系可列方程",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ]
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "贴饰面需要的总钱数",
                    "explain": "已知底1.5米、高1.2米、每平方米80元，求总费用"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "底1.5米、高1.2米、单价80元/平方米",
                        "底和高相等",
                        "每块板1.2平方米",
                        "单价按总价算"
                    ],
                    "answer": "底1.5米、高1.2米、单价80元/平方米",
                    "explain": "平行四边形底1.5米、高1.2米，每平方米要80元"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "面积=1.5×1.2=1.8；总价=1.8×80=144",
                        "1.5×1.2÷80",
                        "(1.5+1.2)×80",
                        "1.5×80+1.2"
                    ],
                    "answer": "面积=1.5×1.2=1.8；总价=1.8×80=144",
                    "explain": "先算面积1.5×1.2=1.8平方米，总价=1.8×80=144元"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "面积=1.5×1.2=1.8㎡，总价=面积×单价=1.8×80=144元",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "红球和白球各有多少个",
                    "explain": "把50个球按3:2分配，分别求红球、白球个数"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "总共50个球，红球:白球=3:2",
                    "explain": "红球占3份、白球占2份，一共5份，对应50个球"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "每份=50÷5=10；红球=30，白球=20",
                        "50÷3=16.7",
                        "50×(3−2)=50",
                        "50−30=20"
                    ],
                    "answer": "每份=50÷5=10；红球=30，白球=20",
                    "explain": "总份数3+2=5，每份50÷5=10个，红球=3×10=30，白球=2×10=20"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "每份=50÷(3+2)=10，红球=3×10=30，白球=2×10=20",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "旗杆的高度",
                    "explain": "小明用身高与影长的比例推算旗杆高度"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "身高1.6米、人影长2米、旗杆影长15米",
                        "旗杆高15米",
                        "身高=影长",
                        "只有旗杆影长"
                    ],
                    "answer": "身高1.6米、人影长2米、旗杆影长15米",
                    "explain": "同一时刻太阳光下，物体越高影子越长，物高与影长成正比"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "上底8米、下底12米、高5米",
                    "explain": "上底=8、下底=12、高=5"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "(8+12)×5÷2=50",
                    "explain": "面积=(上底+下底)×高÷2=20×5÷2=50平方米"
                }
            ],
            "explainLayers": [
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "三角形的底和高",
                    "explain": "已知底比高多3厘米、面积28平方厘米，求底和高"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "面积28平方厘米，底=高+3厘米",
                    "explain": "设高=x厘米，那么底=x+3厘米；底×高÷2=28"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "设高=x：x(x+3)=56，解得x=7",
                    "explain": "底×高÷2=28 → x(x+3)=56 → x²+3x−56=0 → (x−7)(x+8)=0，x=7（高），底=10"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "设高=x、底=x+3，x(x+3)÷2=28，x(x+3)=56，x=7",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "数学对应的圆心角",
                    "explain": "根据各学科人数，求数学在扇形统计图中占的圆心角"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "数学18人，总人数18+20+15+10+7=70",
                        "一共5个学科",
                        "数学人数最多",
                        "没人喜欢数学"
                    ],
                    "answer": "数学18人，总人数18+20+15+10+7=70",
                    "explain": "总人数70，其中数学18人"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "圆心角=360°×18÷70≈93°",
                    "explain": "整个圆是360°，数学占18/70，圆心角=360°×18/70≈93°"
                }
            ],
            "explainLayers": [
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "平移后各顶点的坐标",
                    "explain": "把图形向右2、向上3平移，求新顶点坐标"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "四个顶点(1,2)(3,2)(3,4)(1,4)，向右2、向上3",
                        "图形向左平移",
                        "坐标都不变",
                        "只有一个顶点需要移"
                    ],
                    "answer": "四个顶点(1,2)(3,2)(3,4)(1,4)，向右2、向上3",
                    "explain": "4个顶点坐标已知，向右平移2个单位、向上平移3个单位"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "横坐标+2、纵坐标+3：(1,2)→(3,5)",
                    "explain": "向右平移横坐标加2，向上平移纵坐标加3；第一个顶点(1,2)变为(3,5)，横坐标是3"
                }
            ],
            "explainLayers": [
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "这个角的度数",
                    "explain": "根据补角与余角的关系，求出这个角"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "补角比余角的3倍大20°；补角=180°−x、余角=90°−x",
                        "补角等于余角",
                        "角是90°",
                        "补角和余角相等"
                    ],
                    "answer": "补角比余角的3倍大20°；补角=180°−x、余角=90°−x",
                    "explain": "设角为x，补角=180°−x，余角=90°−x"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "180−x=3(90−x)+20，解得x=70",
                        "x+(90−x)=20",
                        "3x=180−90",
                        "x=90−x+20"
                    ],
                    "answer": "180−x=3(90−x)+20，解得x=70",
                    "explain": "180−x=3(90−x)+20 → 180−x=270−3x+20 → 2x=110 → x=70"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "补角=余角的3倍+20°：180°−x=3(90°−x)+20°，解得x=70°",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "补角=180°−角、余角=90°−角，用方程表示关系再求解",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ]
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "旗杆的高度",
                    "explain": "用镜面反射和相似三角形求旗杆高度"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "镜子离旗杆20米、人离镜子2米、眼睛高1.5米",
                        "旗杆高20米",
                        "人和旗杆一样高",
                        "镜子在旗杆顶端"
                    ],
                    "answer": "镜子离旗杆20米、人离镜子2米、眼睛高1.5米",
                    "explain": "旗杆到镜子20米、人到镜子2米、眼睛离地1.5米"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "旗杆高=1.5×20÷2=15米",
                    "explain": "反射光路形成两个相似直角三角形：旗杆高/20=1.5/2，旗杆高=1.5×20÷2=15米"
                }
            ],
            "explainLayers": [
                {
