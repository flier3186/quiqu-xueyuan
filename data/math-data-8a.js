        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：12、1.5、2",
                    "explain": "从题目中找到的关键数是：12（旗杆影长）、1.5（竹竿高）、2（竹竿影长）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：40、60、45",
                    "explain": "从题目中找到的关键数是：40（AB距离）、60度、45度"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "除法",
                    "explain": "除法：河宽=40×√3×1/(√3+1)≈24.6米"
                }
            ],
            "explainLayers": [
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：13、14、15",
                    "explain": "从题目中找到的关键数是：13、14、15（三边长）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "乘法",
                    "explain": "乘法：半周长=21，面积=√(21×8×7×6)=84平方米"
                }
            ],
            "explainLayers": [
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：6、10、4",
                    "explain": "从题目中找到的关键数是：6（上底）、10（下底）、4（高）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：4 和 60",
                    "explain": "从题目中找到的关键数是：4（长比宽多的厘米数）、60（面积）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "乘法",
                    "explain": "乘法：设宽=x，长=x+4，x(x+4)=60，解得x=6"
                }
            ],
            "explainLayers": [
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：25 和 70",
                    "explain": "从题目中找到的关键数是：25（篮球人数）、70（总人数）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
