  ...
  "7b": {
    ...
    "knowledgeMap": [
      ...
      },
      {
        "id": "7B-03",
        "name": "三角形",
        "concept": "三角形内角和180度，两边之和大于第三边",
        "prerequisite": "7B-02",
        "extends": "7B-04 多边形",
        "visualStrategy": "内角和验证",
        "visualType": "geometry",
        "coreLiteracy": "推理能力",
        "difficulty": 2,
        "isKeyTopic": true
      },
      {
        "id": "7B-04",
        "name": "多边形",
        "concept": "n边形内角和=(n-2)*180度，外角和恒为360度",
        "prerequisite": "7B-03",
        "extends": "小学毕业",
        "visualStrategy": "分割三角形",
        "visualType": "geometry",
        "coreLiteracy": "归纳推理",
        "difficulty": 3,
        "isKeyTopic": false
    ...
    "knowledgeMap": [
      {
        "id": "8A-01",
        "name": "二次根式",
        "concept": "形如sqrt(a)(a≥0)的式子叫做二次根式",
        "prerequisite": "七年级·平方与立方",
        "extends": "8A-02 勾股定理",
        "visualStrategy": "面积开方",
        "visualType": "geometry",
        "coreLiteracy": "运算能力",
      ...
      },
      {
        "id": "8A-02",
        "name": "勾股定理",
        "concept": "直角三角形中，两直角边的平方和等于斜边的平方",
        "prerequisite": "8A-01",
        "extends": "8A-03 实数",
        "visualStrategy": "正方形面积拼接",
        "visualType": "geometry",
        "coreLiteracy": "推理意识",
        "difficulty": 2,
        "isKeyTopic": true
    ...
    "knowledgeMap": [
      {
        "id": "8B-01",
        "name": "分式",
        "concept": "形如A/B(B≠0)的式子叫做分式，B中含有字母",
        "prerequisite": "八年级上·整式运算",
        "extends": "8B-02 反比例函数",
        "visualStrategy": "分数条类比",
        "visualType": "barModel",
        "coreLiteracy": "运算能力",
        "difficulty": 2,
        "isKeyTopic": true
      },
      {
        "id": "8B-02",
        "name": "反比例函数",
        "concept": "形如y=k/x(k≠0)的函数，图像是双曲线",
        "prerequisite": "8B-01",
        "extends": "8B-03 四边形",
        "visualStrategy": "双曲线图像",
        "visualType": "geometry",
        "coreLiteracy": "函数思想",
        "difficulty": 3,
        "isKeyTopic": true
      ...
      },
      {
        "id": "8B-04",
        "name": "数据的分析",
        "concept": "平均数、中位数、众数描述集中趋势，方差描述离散程度",
        "prerequisite": "8B-03",
        "extends": "小学毕业",
        "visualStrategy": "数据分布图",
        "visualType": "barModel",
        "coreLiteracy": "数据分析",
        "difficulty": 2,
        "isKeyTopic": false
    ...
    "knowledgeMap": [
      {
        "id": "9A-01",
        "name": "一元二次方程",
        "concept": "只含一个未知数，未知数最高次数为2的方程",
        "prerequisite": "八年级下·分式方程",
        "extends": "9A-02 二次函数",
        "visualStrategy": "求根公式推导",
        "visualType": "geometry",
        "coreLiteracy": "方程思想",
        "difficulty": 3,
        "isKeyTopic": true
      },
      {
        "id": "9A-02",
        "name": "二次函数",
        "concept": "形如y=ax^2+bx+c(a≠0)的函数，图像是抛物线",
        "prerequisite": "9A-01",
        "extends": "9A-03 旋转",
        "visualStrategy": "抛物线绘制",
        "visualType": "geometry",
        "coreLiteracy": "函数思想",
        "difficulty": 3,
        "isKeyTopic": true
      },
      {
        "id": "9A-03",
        "name": "旋转",
        "concept": "图形绕定点转动一定角度，对应点到定点距离相等",
        "prerequisite": "9A-02",
        "extends": "9A-04 圆",
        "visualStrategy": "旋转动画",
        "visualType": "geometry",
      ...
      },
      {
        "id": "9A-04",
        "name": "圆",
        "concept": "圆上任意点到圆心距离相等；周长C=2πr，面积S=πr²",
        "prerequisite": "9A-03",
        "extends": "小学毕业",
        "visualStrategy": "圆面积分割",
        "visualType": "geometry",
        "coreLiteracy": "几何直观",
        "difficulty": 2,
        "isKeyTopic": true
    ...
    "knowledgeMap": [
      {
        "id": "9B-01",
        "name": "反比例函数综合",
        "concept": "反比例函数与一次函数的交点问题，结合图像分析性质",
        "prerequisite": "八年级下·反比例函数",
        "extends": "9B-02 锐角三角函数",
        "visualStrategy": "双曲线与直线",
        "visualType": "geometry",
        "coreLiteracy": "函数思想",
        "difficulty": 3,
        "isKeyTopic": true
      },
      {
        "id": "9B-02",
        "name": "锐角三角函数",
        "concept": "在直角三角形中，sin=对边/斜边，cos=邻边/斜边，tan=对边/邻边",
        "prerequisite": "9B-01",
        "extends": "9B-03 三视图",
        "visualStrategy": "直角三角形边比",
        "visualType": "geometry",
        "coreLiteracy": "几何直观",
        "difficulty": 3,
        "isKeyTopic": true
      },
      {
        "id": "9B-03",
        "name": "投影与视图",
        "concept": "主视图、俯视图、左视图分别从前、上、左三个方向观察物体",
        "prerequisite": "9B-02",
        "extends": "9B-04 概率",
        "visualStrategy": "三视图展开",
        "visualType": "geometry",
        "coreLiteracy": "空间观念",
        "difficulty": 2,
        "isKeyTopic": false
      },
      {
        "id": "9B-04",
        "name": "随机事件的概率",
        "concept": "概率=有利结果数/总结果数，范围在0到1之间",
        "prerequisite": "9B-03",
        "extends": "小学毕业",
        "visualStrategy": "树状图分析",
        "visualType": "barModel",
        "coreLiteracy": "数据观念",
        "difficulty": 2,
        "isKeyTopic": true
