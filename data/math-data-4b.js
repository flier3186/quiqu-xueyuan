            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "判断21在加法式里是加数还是和",
                    "explain": "题目问的是21在21+13=34里叫什么名称，是加数还是和"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "21+13=34，21是相加的两个数之一",
                        "21是算出来的和",
                        "34是参与相加的数",
                        "13比21大"
                    ],
                    "answer": "21+13=34，21是相加的两个数之一",
                    "explain": "小红有21元，妈妈又给13元，算式21+13=34中，21是参与相加的一个数"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "参与相加的数叫加数：21是加数，填1",
                    "explain": "加法里参与相加的两个数叫加数，结果叫和；21参与了相加，所以是加数，答案填1"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "条形图分两段：绿色加数21、黄色加数13，两段并排凑成总数34",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "21+13=34中，21是参与相加的加数，答案填1",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "判断33在加法式里是加数还是和",
                    "explain": "题目问的是33在33+14=47里叫什么名称，是加数还是和"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "33+14=47，33是相加的两个数之一",
                        "33是算出来的和",
                        "47是参与相加的数",
                        "14比33小"
                    ],
                    "answer": "33+14=47，33是相加的两个数之一",
                    "explain": "小红有33元，妈妈又给14元，算式33+14=47中，33是参与相加的一个数"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "参与相加的数叫加数：33是加数，填1",
                    "explain": "加法里参与相加的两个数都叫加数；33参与了相加，所以是加数，答案填1"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "条形图分两段：绿色加数33、黄色加数14，并排拼成总数47",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "判断48在乘法式里是积还是因数",
                    "explain": "题目问的是48在3×16=48里叫什么名称，是积还是因数"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "3×16=48，48是相乘得到的结果",
                    "explain": "小亮有3盒铅笔每盒16支，3×16=48，48是计算得到的结果"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "相乘的结果叫积：48是积，填1",
                    "explain": "乘法里相乘的两个数叫因数，相乘的结果叫积；48是结果，答案填1"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "面积模型3行×16列共48格，48是整片方格的结果",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "判断72在乘法式里是积还是因数",
                    "explain": "题目问的是72在4×18=72里叫什么名称，是积还是因数"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "4×18=72，72是相乘得到的结果",
                    "explain": "小亮有4盒铅笔每盒18支，4×18=72，72是计算得到的结果"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "相乘的结果叫积：72是积，填1",
                    "explain": "乘法里相乘的两个数叫因数，相乘的结果叫积；72是结果，答案填1"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "面积模型4行×18列共72格，72是整片方格的结果",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "总共38人，大船每船坐8人",
                    "explain": "全班38人，大船每条能坐8人"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "38÷8=4条余6人，进一法要5条",
                    "explain": "38÷8=4条余6人，剩下6人还要再坐1条船，一共4+1=5条"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "条形图：4条大船坐满32人（绿），还剩6人（黄），共38人",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "38÷8=4条余6人，剩下的6人还需1条，一共5条",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "船上的人数=每条船人数×条数，除不尽有余数时要用进一法多取1条",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ],
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "总共60人，大船每船坐5人",
                    "explain": "全班60人，大船每条能坐5人"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "60÷5=12条，正好坐满",
                    "explain": "60÷5=12，正好坐满12条大船，没有剩余"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "每条船人数×条数=总人数，整除时条数=总人数÷每条船人数",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ],
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "113减去34与62之和的差",
                    "explain": "题目问113-(34+62)等于多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "113要减去的是34和62的和",
                    "explain": "113减去的是括号里34+62这两个数的和"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "先算括号：34+62=96，再113-96=17",
                        "先算113-34=79",
                        "34+62+113=209",
                        "113+96=209"
                    ],
                    "answer": "先算括号：34+62=96，再113-96=17",
                    "explain": "括号里34+62=96，再算113-96=17"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "整体条形图：113被分成96（橙）和17（绿）两部分",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                ...
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "连续减去两个数可写成一次减它们的和：a-b-c=a-(b+c)",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ],
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "124减去40与53之和的差",
                    "explain": "题目问124-(40+53)等于多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "124要减去的是40和53的和",
                    "explain": "124减去的是括号里40+53这两个数的和"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "先算括号：40+53=93，再124-93=31",
                        "先算124-40=84",
                        "40+53+124=217",
                        "124+93=217"
                    ],
                    "answer": "先算括号：40+53=93，再124-93=31",
                    "explain": "括号里40+53=93，再算124-93=31"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "整体条形图：124被分成93（橙）和31（绿）两部分",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                ...
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "连续减法可合并：a-b-c=a-(b+c)，先算括号内和再相减",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ],
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "涂色的17份用小数怎么表示",
                    "explain": "题目问涂色的17份用小数表示是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "正方形平均分成100份，涂了17份",
                    "explain": "一个正方形平均分成100份，涂了其中17份"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "17÷100=0.17，十分位0百分位7",
                        "17÷100=0.017",
                        "17÷100=1.7",
                        "17÷100=17"
                    ],
                    "answer": "17÷100=0.17，十分位0百分位7",
                    "explain": "分母是100，17/100写成小数是0.17"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "正方形平均分成100份，涂色17份表示17/100",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "正方形平均分成100份，涂了9份",
                    "explain": "一个正方形平均分成100份，涂了其中9份"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "9÷100=0.09，十分位0百分位9",
                    "explain": "分母是100，9/100写成小数是0.09"
                }
            ],
            "explainLayers": [
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "判断0.3和0.31哪个更大",
                    "explain": "题目问0.3和0.31哪个大"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                        "0.3=0.30，十分位都是3，要看百分位",
                        "0.3大于1",
                        "0.31比0.3小",
                        "两数相等"
                    ],
                    "answer": "0.3=0.30，十分位都是3，要看百分位",
                    "explain": "先比整数部分都是0，再比十分位都是3，要看百分位"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "0.30和0.31的百分位0小于1，0.31大填2",
                        "十分位第一位数大所以0.3大",
                        "0.3大填1",
                        "两数相等填0"
                    ],
                    "answer": "0.30和0.31的百分位0小于1，0.31大填2",
                    "explain": "十分位相同就看百分位，0.31百分位是1更大，答案填2"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "0.3画成10份取3份，0.31画成100份取31份，0.31更细更长",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "0.3=0.30，0.30与0.31比：十分位同、百分位0<1，0.31更大",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "判断0.3和0.35哪个更大",
                    "explain": "题目问0.3和0.35哪个大"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                ...
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "0.30和0.35的百分位0小于5，0.35大填2",
                        "十分位第一位数大所以0.3大",
                        "0.3大填1",
                        "两数相等填0"
                    ],
                    "answer": "0.30和0.35的百分位0小于5，0.35大填2",
                    "explain": "十分位相同就看百分位，0.35百分位是5更大，答案填2"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "0.3画成10份取3份，0.35画成100份取35份，0.35更细更长",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "0.3=0.30，0.30与0.35比：百分位0<5，0.35更大",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "三科成绩78、80、82分",
                    "explain": "三科分别考了78、80、82分"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "总分78+80+82=240，平均=240÷3=80",
                        "平均=78+80+82",
                        "平均=82-78",
                        "平均=240×3"
                    ],
                    "answer": "总分78+80+82=240，平均=240÷3=80",
                    "explain": "先算总分78+80+82=240，再除以3科得平均80"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "三条等长条形分别为78、80、82分，绿色均值块代表80",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "三科成绩86、92、98分",
                    "explain": "三科分别考了86、92、98分"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "总分86+92+98=276，平均=276÷3=92",
                        "平均=86+92+98",
                        "平均=98-86",
                        "平均=276×3"
                    ],
                    "answer": "总分86+92+98=276，平均=276÷3=92",
                    "explain": "先算总分86+92+98=276，再除以3科得平均92"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "三条等长条形分别为86、92、98分，绿色均值块代表92",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "男生条12（绿）比女生条17（黄）短，黄色多出的部分是5",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "男生条13（绿）比女生条18（黄）短，黄色多出的部分是5",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
