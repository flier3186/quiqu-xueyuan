        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "explain": "先求平均数，再求各数据与平均数差的平方和，最后除以数据个数（这里为 6）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "平均数=(15+…+40)÷6=27.5；各偏差平方和=437.5，方差=437.5÷6≈72.9，约为 73",
                        "方差=平均数的平方",
                        "方差=(40-15)÷2",
                        "方差=各数据直接相加"
                    ],
                    "answer": "平均数=(15+…+40)÷6=27.5；各偏差平方和=437.5，方差=437.5÷6≈72.9，约为 73",
                    "explain": "平均 165÷6=27.5；各偏差平方和(-12.5)²+(-7.5)²+(-2.5)²+2.5²+7.5²+12.5²=437.5，方差 437.5÷6≈72.9，四舍五入约为 73"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "平均=27.5，各偏差平方和=437.5，方差=437.5÷6≈72.9，约为 73",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "方差=各数据与平均数的差的平方和÷数据个数，衡量数据波动大小，越小越集中",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ]
