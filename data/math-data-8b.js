        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：2、30",
                    "explain": "从题目中找到的关键数是：2（倍数）、30（差值）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "除法",
                    "explain": "除法：设角为x，补角=180-x，余角=90-x，180-x=2(90-x)+30，解得x=30"
                }
            ],
            "explainLayers": [
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "关键数：20 和 60",
                    "explain": "从题目中找到的关键数是：20（喜欢语文的人数）、60（总人数）"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
