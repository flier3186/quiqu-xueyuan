...
window.MATH_BY_GRADE["5b"] = {
    ...
    "problems": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红发现1/3和3/9一样大。老师告诉她分数的基本性质。」，问的是「1/3等于几分之几？(填分子,分母是5)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
        ...
        },
        {
            ...
            "question": "3/9+3/9等于几分之几？(填分子,分母是5)",
            "formula": "3/9 + 3/9 = ?/9",
            "answer": 6,
            "choices": [
                6,
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红算1/3+1/3。她通分变成3/9+3/9。」，问的是「3/9+3/9等于几分之几？(填分子,分母是5)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
