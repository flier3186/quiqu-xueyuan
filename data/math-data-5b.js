            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "计算结果",
                    "explain": "题目说「小红把15个苹果平均分给5个小朋友。老师告诉15÷5=3，所以5和3都是15的因数。」，问的是「15有几个因数？」，这是求计算结果"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "计算结果",
                    "explain": "题目说「小红把15个苹果装盒，每盒装1个，要装15盒。老师告诉15÷1=15，所以1和15都是15的因数。」，问的是「15有几个因数？」，这是求计算结果"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红发现1/3和3/9一样大。老师告诉她分数的基本性质。」，问的是「1/3等于几分之几？(填分子,分母是9)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红发现1/2和3/6一样大。老师告诉她分数的基本性质。」，问的是「1/2等于几分之几？(填分子,分母是6)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "12的因数有1、2、3、4、6、12；21的因数有1、3、7、21；公共因数中最大的是3",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "13是质数，因数只有1和13；24的因数中没有13，所以13和24互质，最大公因数是1",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红要把分数8/10化成最简分数。她用分子分母同时除以2。」，问的是「8/10约分后分子是几？(分母是5)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红要把分数10/15化成最简分数。她用分子分母同时除以5。」，问的是「10/15约分后分子是几？(分母是3)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红要把1/2和1/3通分。她找到分母2和3的最小公倍数6。」，问的是「1/2通分后分母是6，分子是几？」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红要把1/3和1/4通分。她找到分母3和4的最小公倍数12。」，问的是「1/3通分后分母是12，分子是几？」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "图中将整体平均分成12份，取了4份，表示分数4/12",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红要把0.25化成分数。她知道0.25=25/100。」，问的是「25/100约分后分母是几？(分子是1)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红要把0.125化成分数。她知道0.125=125/1000。」，问的是「125/1000约分后分母是几？(分子是1)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "关键数：0.125 和 1",
                    "explain": "从题目中找到的关键数是：0.125、1"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红算1/3+1/3。她通分变成3/9+3/9。」，问的是「3/9+3/9等于几分之几？(填分子,分母是9)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红算1/3+1/3。她通分变成2/6+2/6。」，问的是「2/6+2/6等于几分之几？(填分子,分母是6)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红算4/5+2/5-1/5。同分母直接加减分子。」，问的是「4/5+2/5-1/5等于几分之几？(填分子,分母是5)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每份是多少（或几份）",
                    "explain": "题目说「小红算4/6+2/6-1/6。同分母直接加减分子。」，问的是「4/6+2/6-1/6等于几分之几？(填分子,分母是6)」，这是求每份是多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
