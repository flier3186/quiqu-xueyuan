...
window.MATH_BY_GRADE["5a"] = {
    ...
    "problems": [
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "每千克大米多少元",
                    "explain": "题目说「小红买4.8千克大米共花了33.6元」，问的是每千克大米多少元"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "总价33.6元、数量4.8千克",
                    "explain": "买了4.8千克大米共花了33.6元，这两个是总价和数量"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "explain": "已知总价33.6元和数量4.8千克求单价，用除法：33.6÷4.8=7元"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "一条条形代表买大米的总价33.6元，平均分给4.8千克",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
        ...
        },
        {
            ...
            "knowledge": "除数是整数的小数除法",
            "difficulty": 2,
            "hint": "先算365÷5=73，商的小数点对齐被除数，得7.3",
            "variants": [
                {
                    "question": "7.2÷9=?",
                    "formula": "7.2÷9=?",
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "花了36.5元，买了5千克",
                    "explain": "总价36.5元，数量5千克"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "单价=总价÷数量：36.5÷5=7.3",
                    "explain": "小数除以整数：先按365÷5=73算，被除数有1位小数，商就有1位小数，得7.3元"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "条形模型：总价36.5元分成5段，每段代表1千克的钱（7.3元），5个7.3就是总价",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "单价=总价÷数量。36.5÷5先按365÷5=73算，被除数有1位小数，商的小数点对齐，得7.3",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "小数除以整数：先按整数除法算，商的小数点要和被除数的小数点对齐",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ],
        ...
        {
            "scene": "小红买4千克苹果共花了12.6元。她算每千克苹果多少元。",
            "question": "每千克苹果多少元？",
            "formula": "12.6 ÷ 4 = ?",
            "answer": 3.15,
            "choices": [
            ...
            "knowledge": "除数是整数的小数除法",
            "difficulty": 2,
            "hint": "先算126÷4=31.5，商的小数点对齐被除数，得3.15",
            "variants": [
                {
                    "question": "7.2÷5=?",
                    "formula": "7.2÷5=?",
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "花了12.6元，买了4千克",
                    "explain": "总价12.6元，数量4千克"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "单价=总价÷数量：12.6÷4=3.15",
                        "12.6+4=16.6",
                        "12.6×4",
                        "4-12.6"
                    ],
                    "answer": "单价=总价÷数量：12.6÷4=3.15",
                    "explain": "小数除以整数：先按126÷4=31.5算，被除数有1位小数，商就有1位小数，得3.15元"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "条形模型：总价12.6元分成4段，每段代表1千克的钱（3.15元），4个3.15就是总价",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "单价=总价÷数量。12.6÷4先按126÷4=31.5算，被除数有1位小数，商的小数点对齐，得3.15",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
        ...
        {
            "scene": "小红做除法7.8÷0.13，她把除数和被除数同时乘100变成780÷13。",
            "question": "780÷13等于多少？",
            "formula": "780 ÷ 13 = ?",
            "answer": 60,
            "choices": [
            ...
            "knowledge": "除数是小数的除法",
            "difficulty": 3,
            "hint": "除数0.13乘100变13，被除数7.8也乘100变780",
            "variants": [
                {
                    "question": "3.6÷0.6=?",
                    "formula": "3.6÷0.6=?",
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "求780÷13的商",
                    "explain": "题目把7.8÷0.13的除数和被除数同时乘100，问转化后的780÷13等于多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "被除数780和除数13",
                    "explain": "转化后是780÷13，被除数780、除数13"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "780÷13=60",
                    "explain": "13×60=780，所以780÷13=60，和7.8÷0.13的商相同"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "除数是小数的除法：把除数和被除数同时乘100，让除数变成整数13，商不变：780÷13=60",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "商不变规律：被除数和除数同时乘相同的数，商不变。除数是小数时先把它变成整数再除",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ],
        ...
        {
            "scene": "小红做除法6.4÷0.16，她把除数和被除数同时乘100变成640÷16。",
            "question": "640÷16等于多少？",
            "formula": "640 ÷ 16 = ?",
            "answer": 40,
            "choices": [
            ...
            "knowledge": "除数是小数的除法",
            "difficulty": 3,
            "hint": "除数0.16乘100变16，被除数6.4也乘100变640",
            "variants": [
                {
                    "question": "3.6÷0.6=?",
                    "formula": "3.6÷0.6=?",
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "求640÷16的商",
                    "explain": "题目把6.4÷0.16的除数和被除数同时乘100，问转化后的640÷16等于多少"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "被除数640和除数16",
                    "explain": "转化后是640÷16，被除数640、除数16"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "640÷16=40",
                    "explain": "16×40=640，所以640÷16=40，和6.4÷0.16的商相同"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "除数是小数的除法：把除数和被除数同时乘100，让除数变成整数16，商不变：640÷16=40",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
        ...
        },
        {
            ...
            "variants": [
                {
                    "question": "2.4千克油每瓶0.4千克需几瓶？",
                    "formula": "2.4÷0.4=?",
                    "answer": 6,
                    "hint": "2.4÷0.4=6，进一法需6瓶"
                },
                {
                    "question": "4米布每件0.6米做几件？",
                    "formula": "4÷0.6=?",
                    "answer": 6,
                    "hint": "4÷0.6≈6.67，去尾法6件"
                }
            ],
            "discoverySteps": [
                {
                    ...
                    "answer": "求需要几个瓶子",
                    "explain": "4.4千克油每瓶装0.8千克，问需要几个瓶子"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "4.4千克油，每瓶装0.8千克",
                    "explain": "油总共4.4千克，每瓶最多装0.8千克"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "瓶数=总油量÷每瓶容量：4.4÷0.8=5.5，进一法取6瓶",
                        "4.4×0.8",
                        "4.4+0.8",
                        "4.4÷0.8=5.5，取5瓶"
                    ],
                    "answer": "瓶数=总油量÷每瓶容量：4.4÷0.8=5.5，进一法取6瓶",
                    "explain": "4.4÷0.8=5.5，5瓶装不完，剩下还要1个瓶子，进一法取6瓶"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "条形模型：4.4千克油，5个瓶子装4千克，还剩0.4千克",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "4.4÷0.8=5.5，5瓶装不完，剩下的也要1个瓶子，所以进一法取6瓶",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
                    "icon": "🚀",
                    "title": "推广 — 通用规律",
                    "text": "生活中装东西用进一法：除不尽时不管余数多少都向前进1；做衣服等用去尾法：不够一件的舍去",
                    "bg": "var(--coral-soft)",
                    "color": "var(--coral)"
                }
            ],
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "求需要几个瓶子",
                    "explain": "4.5千克油每瓶装0.11千克，问需要几个瓶子"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "4.5千克油，每瓶装0.11千克",
                    "explain": "油总共4.5千克，每瓶最多装0.11千克"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "瓶数=总油量÷每瓶容量：4.5÷0.11≈40.9，进一法取41瓶",
                        "4.5×0.11",
                        "4.5+0.11",
                        "4.5÷0.11≈40.9，取40瓶"
                    ],
                    "answer": "瓶数=总油量÷每瓶容量：4.5÷0.11≈40.9，进一法取41瓶",
                    "explain": "4.5÷0.11≈40.9，40瓶装不完，剩下还要1个瓶子，进一法取41瓶"
                }
            ],
            "explainLayers": [
                {
                    "icon": "👀",
                    "title": "看图 — 图形结构",
                    "text": "条形模型：4.5千克油，40个瓶子装4.4千克，还剩0.1千克",
                    "bg": "var(--teal-soft)",
                    "color": "var(--teal)"
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "4.5÷0.11≈40.9，40瓶装不完，剩下的也要1个瓶子，所以进一法取41瓶",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    "q": "📖 再读一遍场景，这道题要我们求什么？",
                    "choices": [
                        "摸出红球属于哪种情况（一定/不可能/可能）",
                        "摸到几个红球",
                        "红球一共几个",
                        "摸几次球"
                    ],
                    "answer": "摸出红球属于哪种情况（一定/不可能/可能）",
                    "explain": "题目说袋里有6个红球、闭眼摸一个，要判断摸到红球是「一定」「不可能」还是「可能」"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                ...
                },
                {
                    ...
                    "answer": "全是红球必然摸到红，填1",
                    "explain": "6个球全是红球，无论摸哪个都是红色，所以一定摸到红球，填1"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "6个都是红球、没有其它颜色，任意摸一个是红，一定摸红填1",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "摸出红球属于哪种情况（一定/不可能/可能）",
                    "explain": "题目说袋里有7个红球、闭眼摸一个，要判断摸到红球是「一定」「不可能」还是「可能」"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                ...
                },
                {
                    ...
                    "answer": "全是红球必然摸到红，填1",
                    "explain": "7个球全是红球，无论摸哪个都是红色，所以一定摸到红球，填1"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "7个都是红球、没有其它颜色，任意摸一个是红，一定摸红填1",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "哪种颜色的球被摸到的可能性大",
                    "explain": "袋里有3个红球和1个蓝球，要看摸到哪一种颜色的可能性更大"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                ...
                },
                {
                    ...
                    "answer": "红球3个比蓝球1个多，摸红可能性大填1",
                    "explain": "红球3个、蓝球1个，红球多，所以摸到红球的可能性更大，填1"
                }
            ],
            "explainLayers": [
                {
            ...
            "discoverySteps": [
                {
                    ...
                    "answer": "这个游戏是否公平",
                    "explain": "小红摸到红赢、小亮摸到蓝赢，要看红蓝两种结果机会是否相等"
                },
                {
                    "q": "🔢 题目给了我们哪些关键信息？",
                    "choices": [
                    ...
                    "answer": "红球3个、蓝球3个，数量相等",
                    "explain": "袋中红球3个、蓝球3个，两种颜色的球一样多"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                    ...
                    "answer": "红蓝数量相等、机会相同，公平填1",
                    "explain": "红球蓝球一样多，摸到红和摸到蓝的机会相同，游戏公平，填1"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "红球3个、蓝球3个数量相等，双方摸赢机会相同，公平填1",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
        ...
        },
        {
            ...
            "discoverySteps": [
                ...
                },
                {
                    ...
                    "answer": "红球4个、蓝球2个，数量不同",
                    "explain": "袋中红球4个、蓝球2个，红球数量更多"
                },
                {
                    "q": "🧩 用什么方法计算？",
                    "choices": [
                        "红球4个比蓝球2个多，小红机会更大不公平填3",
                        "数量相同公平填1",
                        "蓝球更多",
                        "无法判断"
                    ],
                    "answer": "红球4个比蓝球2个多，小红机会更大不公平填3",
                    "explain": "红球4个、蓝球2个，小红摸到红的机会更大，机会不相等所以不公平，填3"
                }
            ],
            "explainLayers": [
                {
                ...
                },
                {
                    "icon": "🧠",
                    "title": "理解 — 数学关系",
                    "text": "红球4个多于蓝球2个，小红摸红的机会更大，不公平填3",
                    "bg": "var(--yellow-soft)",
                    "color": "var(--yellow-700)"
                },
                {
