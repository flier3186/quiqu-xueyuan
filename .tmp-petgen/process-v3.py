...
SRC = os.path.join(os.path.dirname(os.path.abspath(__file__)), "v3")
OUT = os.path.join(SRC, 'out')
os.makedirs(OUT, exist_ok=True)

MAP = {
    '第一张图是这个黑猫角色的官方3D渲染版_第二张是它的2D设定_2026-09-06T04-35-08.png': 'cat-idle.png',
    os.path.join('mood-celebrate', '保持这只3D渲染黑猫角色的形象完全不变_同样的奶白厚眼圈超大_2026-09-06T04-35-40.png'): 'cat-celebrate.png',
    os.path.join('mood-comfort', '保持这只3D渲染黑猫角色的形象完全不变_同样的奶白厚眼圈超大_2026-09-06T04-35-58.png'): 'cat-comfort.png',
    os.path.join('mood-eat', '保持这只3D渲染黑猫角色的形象完全不变_同样的奶白厚眼圈超大_2026-09-06T04-36-20.png'): 'cat-eat.png',
    os.path.join('mood-sleep2', '保持这只3D渲染黑猫角色的形象完全不变_暖紫棕体色_黄绿耳内_2026-09-06T04-37-34.png'): 'cat-sleep.png',
}
