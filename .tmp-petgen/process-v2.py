...
SRC = os.path.join(os.path.dirname(os.path.abspath(__file__)), "v2")
OUT = os.path.join(SRC, 'out')
os.makedirs(OUT, exist_ok=True)

MAP = {
    '3D渲染卡通风格小黑猫全身坐姿_皮克斯式柔和立体渲染_圆润光_2026-09-06T04-14-40.png': 'cat-idle.png',
    os.path.join('mood-celebrate', '保持这只3D渲染小黑猫的角色设计完全不变_通体漆黑无白毛_绿_2026-09-06T04-15-15.png'): 'cat-celebrate.png',
    os.path.join('mood-comfort', '保持这只3D渲染小黑猫的角色设计完全不变_通体漆黑无白毛_绿_2026-09-06T04-15-35.png'): 'cat-comfort.png',
    os.path.join('mood-eat', '保持这只3D渲染小黑猫的角色设计完全不变_通体漆黑无白毛_绿_2026-09-06T04-16-00.png'): 'cat-eat.png',
    os.path.join('mood-sleep', '保持这只3D渲染小黑猫的角色设计完全不变_通体漆黑无白毛_绿_2026-09-06T04-16-27.png'): 'cat-sleep.png',
}
